...
def resampleOvarianVoxelT2():
    ...
    for file in files:
        ...
        if fileName == 'OT.nii':
            ...
            ref = nePath + '/' + 'CT_MTT.nii'

            command = 'C:/research/Slicer/Slicer.exe'
            resample(file, output_filename=newPath, method='slicer', command=command, interpolation='nn',
                     dimensions=[1, 1, 1], reference_volume=ref)
